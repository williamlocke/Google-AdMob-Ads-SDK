{
  ...
  "source_files": [
    "GoogleMobileAdsSdkiOS-6.12.0/*.h",
    "GoogleMobileAdsSdkiOS-6.12.0/Add-ons/DoubleClick/*.h"
  ],
  "preserve_paths": "GoogleMobileAdsSdkiOS-6.12.0",
  "frameworks": [
    "AdSupport",
    "AudioToolbox",
    "AVFoundation",
  ...
  "xcconfig": {
    "LIBRARY_SEARCH_PATHS": "\"$(PODS_ROOT)/Google-AdMob-Ads-SDK/GoogleMobileAdsSdkiOS-6.12.0\""
  },
  "requires_arc": false
}